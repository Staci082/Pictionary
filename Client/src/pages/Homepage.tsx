  ...
  const handleSubmit = (e: { preventDefault: () => void; }) => {
    ...
    return (
        <form className="flex flex-col items-center gap-8">
            ...
            <button onClick={handleSubmit} className="w-[300px] bg-violet-700 p-2 rounded-lg w-[300] text-white font-bold shadow-xl shadow-indigo-950/50 hover:translate-y-1 hover:bg-indigo-600">
                PLAY!
            </button>
        </form>
    );
